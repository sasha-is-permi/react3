...
https://github.com/sasha-is-permi/react3
...
// Информация записывается в .git/config
git remote add origin https://github.com/sasha-is-permi/react3
...
git clone https://github.com/sasha-is-permi/react3 react3
// Файлы копируются с респозитория в папку react3

// Затем зайти в файл проекта react3

// Если проект уже есть- прописанны все пути в нем до github- 
// просто:
// зайти в visual studio code, terminal, в каталог react3
git pull
